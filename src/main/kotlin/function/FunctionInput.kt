...
sealed interface FunctionInput {
    ...
    data class PermuteInput(val tensors: Tensor, val permute: IntArray) : FunctionInput{}
    ...
    data class MatMulInput(val tensor1: Tensor,val tensor2: Tensor): FunctionInput{}
}